...
if ($post_query->have_posts()):
    while ($post_query->have_posts()):
        $post_query->the_post();
			if (types_render_field( "resourceprivate") == 'public' ||types_render_field( "resourceprivate")  == 'private, public') :
...
if ($post_query->have_posts()):
    while ($post_query->have_posts()):
        $post_query->the_post();
        if (types_render_field( "testimonials-type") == 'public' ||types_render_field( "testimonials-type") == 'both') :
